...
package PortafolioOFICIALDanielaMurillo.PortafolioOFICIALDanielaMurillo;
...
public class ProjectConfig implements WebMvcConfigurer {
    ...
    @Bean
    public LocaleResolver localeResolver(){var slr = new SessionLocaleResolver();
    ...
    @Bean
    public LocaleChangeInterceptor localeChangeInterceptor(){var lci = new LocaleChangeInterceptor();
        lci.setParamName("lang");
        return lci;}

    @Override
    public void addInterceptors(InterceptorRegistry registro) {registro.addInterceptor(localeChangeInterceptor());}
...
@Bean
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http.authorizeHttpRequests((request) -> request
            ...
            .requestMatchers("/producto/listado","/categoria/listado","/usuario/listado").hasAnyRole("ADMIN", "VENDEDOR")
